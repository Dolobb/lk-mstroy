...
export function DumpTruckIcon({ className, strokeWidth = 1.5 }: IconProps) {
  return (
    <svg viewBox="0 0 64 40" fill="none" stroke="currentColor" strokeWidth={strokeWidth}
         strokeLinecap="round" strokeLinejoin="round" className={className}>
      {/* Dump bed */}
      <path d="M4 26 L8 8 L36 8 L36 26 Z" />
      {/* Hydraulic */}
      <line x1="20" y1="26" x2="22" y2="12" strokeWidth={strokeWidth * 0.8} />
      {/* Cab */}
      <rect x="37" y="14" width="20" height="12" rx="2" />
      <path d="M37 18 L43 18 L43 14" />
      <rect x="50" y="16" width="5" height="5" rx="1" strokeWidth={strokeWidth * 0.7} />
      {/* Chassis */}
...
export function SemiTruckIcon({ className, strokeWidth = 1.5 }: IconProps) {
  return (
    <svg viewBox="0 0 80 40" fill="none" stroke="currentColor" strokeWidth={strokeWidth}
         strokeLinecap="round" strokeLinejoin="round" className={className}>
      {/* Trailer */}
      <rect x="2" y="10" width="44" height="18" rx="2" />
      <line x1="14" y1="10" x2="14" y2="28" strokeWidth={strokeWidth * 0.6} />
      <line x1="26" y1="10" x2="26" y2="28" strokeWidth={strokeWidth * 0.6} />
      <line x1="38" y1="10" x2="38" y2="28" strokeWidth={strokeWidth * 0.6} />
      {/* Cab */}
      ...
      {/* Hitch */}
      <line x1="44" y1="22" x2="46" y2="22" strokeWidth={strokeWidth * 1.2} />
      {/* Wheels */}
...
export function HeavyMachineryIcon({ className, strokeWidth = 1.5 }: IconProps) {
  return (
    <svg viewBox="0 0 64 40" fill="none" stroke="currentColor" strokeWidth={strokeWidth}
      ...
      <circle cx="14" cy="28" r="5" strokeWidth={strokeWidth * 0.6} />
      {/* Engine / body */}
      <rect x="24" y="16" width="26" height="14" rx="2" />
      {/* Cab */}
      <rect x="30" y="8" width="14" height="10" rx="2" />
      <rect x="33" y="10" width="8" height="5" rx="1" strokeWidth={strokeWidth * 0.7} />
      {/* Exhaust pipe */}
      <line x1="36" y1="8" x2="36" y2="4" />
      {/* Rear wheel */}
      <circle cx="54" cy="30" r="7" />
      <circle cx="54" cy="30" r="3" strokeWidth={strokeWidth * 0.6} />
      {/* Frame connection */}
      <line x1="23" y1="28" x2="14" y2="28" strokeWidth={strokeWidth * 0.8} />
    </svg>
  )
}
