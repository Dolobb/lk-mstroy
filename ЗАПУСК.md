...
cd tyagachi;.venv\Scripts\activate;python main.py --web --port 8000

# Терминал 4 — Единый фронтенд (UI)
...
```powershell
cd tyagachi && .venv\Scripts\activate

# 1 неделя
python main.py --fetch --from 19.02.2026 --to 25.02.2026

# Полный месяц
python main.py --fetch --from 01.02.2026 --to 25.02.2026
```
